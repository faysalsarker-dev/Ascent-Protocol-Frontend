    ...
    >
      <div className="flex items-center gap-4">
        ...
        <div className="relative w-16 h-16 flex-shrink-0">
          <motion.div
            className="absolute inset-0 rounded-lg bg-gradient-to-br from-primary/20 to-secondary/20 flex items-center justify-center"
            animate={{
              boxShadow: [
          ...
          >
            <Dumbbell className="w-8 h-8 text-primary breathing-neon" />
          </motion.div>
